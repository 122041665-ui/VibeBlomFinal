    ...
    <x-dialog-modal wire:model.live="displayingToken">
        ...
        <x-slot name="content">
            ...
            <x-input x-ref="plaintextToken" type="text" readonly :value="$plainTextToken"
                class="mt-4 bg-slate-50 dark:bg-slate-800 px-4 py-2 rounded-xl border border-gray-200 dark:border-slate-700 font-mono text-sm text-gray-600 dark:text-slate-300 w-full break-all"
